...
Namespace QHY
    ...
    Public Class QHY
        ...
        Public Shared Function GetCallLog() As List(Of String)
            ...
            Dim SecSinceLastEnd As Integer
            For Each SingleCall As List(Of KeyValuePair(Of String, Object)) In CallLog
                ...
                For Each Arg As KeyValuePair(Of String, Object) In SingleCall
                    Select Case Arg.Key
                        Case LogKeys.FunctionName
                            FunctionName = CStr(Arg.Value).PadRight(30)
                        ...
                        Case LogKeys.CallStart
                            ...
                            If LastEnd <> DateTimeOffset.MinValue Then
                                SecSinceLastEnd = CInt((StartTime - LastEnd).TotalMilliseconds)
                            Else
                                SecSinceLastEnd = 0
                            End If
                        Case Else
                ...
                LogContent.Add("After " & SecSinceLastEnd.ToString.PadLeft(10) & " ms, took " & CallDuration.ToString.PadLeft(10) & "ms: " & FunctionName & ("(" & Join(Arguments.ToArray, ",") & ")").PadRight(110) & " -> " & ReturnVal.PadLeft(15))
            Next SingleCall
            Return LogContent
        End Function
